...
INSERT INTO "new_Student" ("ageBand", "alias", "createdAt", "defaultFormat", "id", "identifiesAs", "letterSpacing", "lineHeight", "onboarded", "readingTheme", "readingTint", "showStepCount", "soundOn") SELECT "ageBand", "alias", "createdAt", "defaultFormat", "id", "identifiesAs", "letterSpacing", "lineHeight", "onboarded", "readingTheme", "readingTint", "showStepCount", "soundOn" FROM "Student";
DROP TABLE "Student";
